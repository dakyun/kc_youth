...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/resetfornote.css?ts=${java.lang.System.currentTimeMillis()}">
    <link rel="stylesheet" href="/assets/css/note.css?ts=${java.lang.System.currentTimeMillis()}">
    <script src="/assets/script/note.js?ts=${java.lang.System.currentTimeMillis()}"></script>
